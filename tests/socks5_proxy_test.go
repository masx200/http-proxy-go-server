...
`
	...
	testResults = append(testResults, "")
	testResults = append(testResults, "等效命令: `curl -v -I -X GET https://www.zhihu.com -x socks5://g7envpwz14b0u55:juvytdsdzc225pq@127.0.0.1:44444`")
	testResults = append(testResults, "")

	// 创建HTTPS测试请求
	req2, err := http.NewRequest("HEAD", "https://www.zhihu.com", nil)
	if err != nil {
