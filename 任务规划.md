...
- [ ] 分析现有的 WebSocket 代理实现，复用架构设计
- [ ] 定义 SOCKS5 上游代理的配置结构
- [ ] 设计 SOCKS5 代理客户端接口集成方案
- [ ] 规划与现有代理系统的集成方案
...
- [ ] 扩展 UpStream 结构体，添加 SOCKS5 相关字段
- [ ] 更新 Config 结构体以支持新配置
- [ ] 修改配置文件解析逻辑
- [ ] 添加 SOCKS5 代理配置验证
...
- [ ] 修改 SelectProxyURLWithCIDR 函数支持 socks5:// 协议
- [ ] 实现 SOCKS5 代理的特殊处理逻辑
- [ ] 添加 socks5:// 协议前缀的判断逻辑
- [ ] 在 transportConfigurations 中集成 SOCKS5 代理
