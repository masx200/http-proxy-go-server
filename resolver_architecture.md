...
```go
func CreateDOHResolver(Proxy func(*http.Request) (*url.URL, error),proxyoptions options.ProxyOptions, Proxy func(*http.Request) (*url.URL, error), tranportConfigurations ...func(*http.Transport) *http.Transport) NameResolver
```
...
```go
func CreateHostsAndDohResolver(Proxy func(*http.Request) (*url.URL, error),proxyoptions options.ProxyOptions, Proxy func(*http.Request) (*url.URL, error), tranportConfigurations ...func(*http.Transport) *http.Transport) NameResolver
```
