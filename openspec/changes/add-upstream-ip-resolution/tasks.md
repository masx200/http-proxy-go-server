...
- [x] 1.6 Implement upstream domain to IP resolution function in options/options.go
- [x] 1.7 Modify Proxy_net_dial function to support IP-based upstream connections
